      ...
      {loading ? (
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            {/* ── CARD 1: Identity (Name, Display Name, Admin ID, Role) ── */}
            ...
            {/* ── CARD 2: Sensitive fields (Email / Phone) with OTP gate ── */}
          ...
          <div className="space-y-5">
            <Card className="space-y-4">
              ...
              {/* Step 2: Enter OTP */}
              {pwdStep === 2 && (
                <form onSubmit={handleVerifyPwdOtp} className="space-y-4 pt-1">
