...
import { ShoppingBag, CalendarDays, Download, Search } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          Historical record of all paid invoice transactions.
        </p>
      </div>

      {/* Orders Table */}
      <Card className="p-0 overflow-hidden overflow-x-auto">
        <Table headers={['Invoice Number', 'Customer', 'Quantity per packet', 'Packets count', 'Price', 'CGST', 'SGST', 'Grand Total', 'Billing Date', 'Status', 'Download Invoice']}>
          {orders.length === 0 ? (
            <tr>
              <td colSpan={11} className="px-6 py-8 text-center text-xs text-slate-400">
